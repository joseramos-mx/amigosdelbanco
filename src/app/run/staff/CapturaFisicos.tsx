    ...
    <section className="mt-10">
      ...
      <div className="mt-4 rounded-xl border border-white/10 bg-run-card px-5 py-5">
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label className={etiqueta} htmlFor="telefonoFisico">Teléfono (Opcional)</label>
              <input
                id="telefonoFisico"
                type="tel"
                value={telefono}
            ...
            <div>
              <label className={etiqueta} htmlFor="correoFisico">Correo Electrónico (Opcional)</label>
              <input
                id="correoFisico"
                type="email"
                value={correo}
